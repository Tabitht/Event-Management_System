...
const Register = () => {
  ...
  return (
    <>
      <div
        className="w-[100%] md:h-[1178px] py-[1rem] font-raleway flex justify-center"
        style={{
        ...
        <div className="w-[90%] md:w-[70%] h-[70%] md:h-[1022px] py-[1rem] bg-white mt-[3rem]">
          ...
          <div className="flex flex-col gap-[1rem] md:gap-[2rem] text-start px-[2rem] md:px-[4rem]">
            ...
            <label>
              ...
              />
              <span className="font-raleway text-[0.75rem] text-[#412234]">
                By checking this box, you agree to the{" "}
                <span className="font-raleway text-[0.75rem] text-[#412234] font-semibold">
                  Terms & Condition
                </span>{" "}
                and{" "}
                <span className="font-raleway text-[0.75rem] text-[#412234] font-semibold">
