            ...
            >
                <div className="w-[90%] md:w-[70%] py-[1rem] md:h-[828px] bg-white">
                    ...
                    <div className="flex flex-col gap-[1.5rem] md:gap-[3rem] px-[2rem] md:px-[4rem] text-start">
                        <div>
                            <p className="text-[1rem] md:text-[1.5rem] font-bold text-[#131B22]">Welcome Back !</p>
                            <p className="text-[0.75rem] md:text-[1rem] text-[#586675]">Kindly input your details below to log into your account</p>
                        </div>
                        ...
                        <div className="flex justify-center gap-[3px] text-center">
                            <p className=" text-[1rem] text-[#412234] text-center">Don`t have an account? </p> 
                            <p className="text-[1rem] text-[#412234] font-bold">
                                <Navigation link="/SignUp" label="Create an Account"></Navigation>
                            </p>
                        </div>
                    </div>
                </div>
