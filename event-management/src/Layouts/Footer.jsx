        ...
        <div className="flex justify-center">
            ...
            <div className="flex flex-row mt-[20px] xl:gap-[30px]">
                <div className="flex flex-col text-[#FFFFFF] text-[0.5rem] md:text-[1rem] xl:text-[16px] items-start font-thin font-raleway xl:ml-[50px] xl:gap-[40px]">
                    ...
                    <p className="w-[50%] md:w-[70%] xl:w-[325px] text-left">Tickety is an e booking app that aims to make organizing events easy and streamlined for organizers and event attendees.</p>
                ...
                <div className="flex flex-col text-[#FFFFFF] text-[0.5rem] md:text-[1rem] xl:text-[16px] text-left font-thin font-raleway xl:ml-[30px] xl:gap-[40px]">
                ...
                <div className="flex flex-col text-[#FFFFFF] text-[0.5rem] md:text-[1rem] xl:text-[16px] text-left font-thin font-raleway xl:ml-[20px] xl:gap-[40px]">
                ...
                <div className="flex flex-col text-[#FFFFFF] text-[0.5rem] md:text-[1rem] xl:text-[16px] items-start text-left font-thin font-raleway xl:ml-[20px] xl:gap-[40px]">
            ...
            <div className="flex flex-col mt-[40px] items-start xl:ml-[50px] gap-[10px]">
                <p className="text-[#FFFFFF] xl:text-[16px] items-start font-thin font-raleway">Subscribe to get latest updates</p>
                <form>
                    <input 
                    type="email"
                    placeholder="Enter Email"
                    className="w-[60%] xl:w-[369px] h-[56px] rounded-l-[8px]"
                    />
