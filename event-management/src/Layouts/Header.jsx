...
const Header = () => {
    return (
        <div className="flex justify-center">
            <div className="items-center w-screen md:h-[104px] bg-[#FFFFFF] border-[1px] px-[40px] border-[#806B77] flex flex-row justify-between">
                <div className="md:hidden"><NavBar /></div>
                <div className="md:text-[2rem] font-bold text-[#412234] font-pattaya md:ml-[40px]">Tickety</div>
